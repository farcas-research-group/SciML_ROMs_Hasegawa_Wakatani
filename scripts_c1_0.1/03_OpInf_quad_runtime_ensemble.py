...
print('\033[1m State evaluation time {}, {} \033[0m'.format(np.mean(times), np.std(times, ddof=1)))
...
print('\033[1m Output evaluation time {}, {} \033[0m'.format(np.mean(times), np.std(times, ddof=1)))
