...
data = np.load('/storage1/HW/paper/res_c1_0.1/reg_params_ensemble_c1_0.1_training_end' + str(training_size) + '_r'+str(r)+'.npz')
...
for alpha_pair_state in alphas_state:
	...
	if not is_nan:
		for alpha_pair_output in alphas_output:
			...
			mean_err = 0.5*(std_err_Gamma_n_pred + std_err_Gamma_c_pred)
...
np.savez('/storage1/HW/paper/res_c1_0.1/postprocessing_ensemble_c1_5.0_training_end' + str(training_size) + '_r'+str(r)+'.npz', \
