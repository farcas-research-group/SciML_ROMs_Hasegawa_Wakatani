...
data = np.load('results/bad_reg_params_c1_0.1_training_end' + str(training_size) + '_r'+str(r)+'.npz')


alpha_state_lin_best 	= data['alpha_state_lin_best']
alpha_state_quad_best 	= data['alpha_state_quad_best']

alpha_out_lin_best 	= data['alpha_out_lin_best']
alpha_out_quad_best = data['alpha_out_quad_best']
...
regg            = np.zeros(d_out)
regg[:r] 		= alpha_out_lin_best
regg[r:r + s] 	= alpha_out_quad_best
regg[r + s:] 	= alpha_out_lin_best
regularizer     = np.diag(regg)
...
np.savez('results/Gamma_bad_reg_c1_0.1_training_end' + str(training_size) + '_r'+str(r)+'.npz', \
        Gamma_n=ts_Gamma_n, Gamma_c=ts_Gamma_c)