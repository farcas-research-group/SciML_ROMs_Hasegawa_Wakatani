...
data = np.load('/storage1/HW/paper/res_c1_1.0/reg_params_ensemble_c1_1.0_training_end' + str(training_size) + '_r'+str(r)+'.npz')
...
for alpha_pair_state in alphas_state:
	...
	if not is_nan:
		for alpha_pair_output in alphas_output:
			...
			mean_err = np.mean([mean_err_Gamma_n_pred, std_err_Gamma_n_pred, mean_err_Gamma_c_pred, std_err_Gamma_c_pred])
...
np.savez('/storage1/HW/paper/res_c1_1.0/postprocessing_ensemble_c1_1.0_training_end' + str(training_size) + '_r'+str(r)+'.npz', \
