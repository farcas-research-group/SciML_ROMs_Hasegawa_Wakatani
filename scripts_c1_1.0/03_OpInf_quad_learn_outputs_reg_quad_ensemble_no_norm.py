...
np.savez('/storage1/HW/paper/res_c1_1.0/Gamma_ensemble_c1_1.0_training_end' + str(training_size) + '_r'+str(r)+'.npz', \
        Gamma_n_ensemble=Gamma_n_ensemble, Gamma_c_ensemble=Gamma_c_ensemble)

np.savez('/storage1/HW/paper/res_c1_1.0/reg_params_ensemble_c1_1.0_training_end' + str(training_size) + '_r'+str(r)+'.npz', \
